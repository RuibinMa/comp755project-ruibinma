...
parser.add_argument('--whitening', '-w', metavar='WHITENING', default=None, choices=whitening_names,
                    help='dataset used to learn whitening for testing: ' + 
                        ...
                        ' (default: None)')
parser.add_argument('--save-score-path', help='save score matrix into this path (numpy, .bin)')

group_lw = parser.add_mutually_exclusive_group()
group_lw.add_argument('--save_lw_path', help='save the learned m and P in this file', default=None)
group_lw.add_argument('--load_lw_path', help='load lw (m and P) from this file (.pkl)', default=None)
...
def main():
    ...
    for dataset in datasets: 
        ...
        if Lw is not None:
            ...
            if args.save_score_path:
                name = os.path.splitext(args.save_score_path)
                name = name[0] + '-whiten' + name[1]
